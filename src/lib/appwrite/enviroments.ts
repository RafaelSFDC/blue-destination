...
export const COLLECTIONS = {
  ...
  blog_categories: process.env.NEXT_PUBLIC_APPWRITE_BLOG_CATEGORIES_ID!,
  blog_comments: process.env.NEXT_PUBLIC_APPWRITE_BLOG_COMMENTS_ID!,
  blog_authors: process.env.NEXT_PUBLIC_APPWRITE_BLOG_AUTHORS_ID!,
